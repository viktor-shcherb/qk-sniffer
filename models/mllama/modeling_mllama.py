...
from transformers.utils.generic import OutputRecorder, check_model_inputs, is_flash_attention_requested, maybe_autocast
from transformers.models.mllama.configuration_mllama import MllamaConfig, MllamaTextConfig, MllamaVisionConfig


try:  # optional sniffer dependency
    from sniffer import compute_positions, get_active_sniffer
except ImportError:  # pragma: no cover
    def compute_positions(*args, **kwargs):
        return None

    def get_active_sniffer():
        return None
    ...
    def forward(
        ...
        **kwargs,
        ...
        if sniffer is not None:
            capture_pre_rope = bool(getattr(getattr(sniffer, "config", None), "capture_pre_rope", False))
